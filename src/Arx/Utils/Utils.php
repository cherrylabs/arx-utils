...
class Utils
{
    ...
    public static function __callStatic($sName, $aArgs)
    {
        ...
        switch (true) {
            case method_exists('\Arx\Utils\Strings', $sName):
                return call_user_func_array(array('\Arx\Utils\Strings', $sName), $aArgs);
            case method_exists('\Arx\Utils\Arr', $sName):
                return call_user_func_array(array('\Arx\Utils\Arr', $sName), $aArgs);
        }
