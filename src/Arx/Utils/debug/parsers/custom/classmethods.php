    ...
    protected function _parse(&$variable)
    {
        ...
        if(!isset(self::$cache[$className])) {
            ...
            foreach($reflection->getMethods() as $method) {
                ...
                $output = new \Arx\Utils\debug\kintVariableData();
                ...
                $fileName = \Arx\Utils\debug\Kint::shortenPath($method->getFileName(), $method->getStartLine());
